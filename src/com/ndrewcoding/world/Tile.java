...
public class Tile {
	...
	public static BufferedImage TILE_WHITE_FLOOR = Game.spritesheet.getSprite(0, 64, 16, 16);
	...
	// public static BufferedImage TILE_WALL10 = Game.spritesheet.getSprite(0, 48,
	// 16, 16);
